...
module.exports = {
    ...
    URL_2NAME: process.env.URL_2NAME === undefined ? '✨قروب تعليم البوتات ✨' : process.env.URL_2NAME,
    URL_2LINK: process.env.URL_2LINK === undefined ? 'https://chat.whatsapp.com/Gb62eN2S5yI9mhfdn6Ma4z' : process.env.URL_2LINK,
    FOOTER: process.env.FOOTER === undefined ? 'BOBIZBOT-MD  https://wa.me/+967770500831  تابعني على واتساب ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '⚜️𝙱𝙾𝚃_𝚁𝙰𝙸𝚉𝙴𝙻⚜️ https://wa.me/+967770500831🤠' : process.env.CAPTION,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/39272916fd98efa5fec86.jpg' : process.env.ALIVE_LOGO,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? '⚜️𝙱𝙾𝚃_𝚁𝙰𝙸𝚉𝙴𝙻⚜️' : process.env.STIC_WM,
};
